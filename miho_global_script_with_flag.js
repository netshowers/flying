...
function main(config) {
  ...
  if (ruleOptions.fubotv) {
    ...
    config['proxy-groups'].push({
      ...
      icon: 'https://fastly.jsdelivr.net/gh/Koolson/Qure@refs/heads/master/IconSet/Color/FOX.png',
    })
  }
  ...
  if (ruleOptions.dazn) {
    ...
    config['proxy-groups'].push({
      ...
      icon: 'https://fastly.jsdelivr.net/gh/Koolson/Qure@refs/heads/master/IconSet/Color/DAZN_1.png',
    })
  }
